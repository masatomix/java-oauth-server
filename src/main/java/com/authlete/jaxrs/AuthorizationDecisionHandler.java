 ...
 * authorization request. This class handles the decision and calls Authlete's
 * {@code /api/auth/authorization/issue} API or
 * {@code /api/auth/authorization/fail} API accordingly.
 * </p>
 *
...
public class AuthorizationDecisionHandler {
     ...
     * an implementation of {@link AuthorizationDecisionHandlerSpi} interface.
     *
     * @param api
     *            Implementation of {@link AuthleteApi} interface.
     *
     * @param spi
     *            Implementation of {@link AuthorizationDecisionHandlerSpi}
     *            interface.
     */
    public AuthorizationDecisionHandler(AuthorizationDecisionHandlerSpi spi) {
     ...
     *
     * @param ticket
     *            A ticket that was issued by Authlete's
     *            {@code /api/auth/authorization} API.
     *
     * @param claimNames
     *            Names of requested claims. Use the value of the {@code claims}
     *            parameter in a response from Authlete's
     *            {@code /api/auth/authorization} API.
     *
     * @param claimLocales
     *            Requested claim locales. Use the value of the
     *            {@code claimsLocales} parameter in a response from Authlete's
     *            {@code /api/auth/authorization} API.
     *
     * @return A response to the client application. Basically, the response
     *         will trigger redirection to the client's redirection endpoint.
     *
     * @throws WebApplicationException
     *             An error occurred.
     */
    public Response handle(String ticket, String[] claimNames,
            String[] claimLocales) throws WebApplicationException {
        try {
            ...
            // Unexpected error.
            throw unexpected("Unexpected error in AuthorizationDecisionHandler",
                    t);
        }
    }
     ...
     * Process the end-user's decision.
     */
    private Response process(String ticket, String[] claimNames,
            String[] claimLocales) {
        ...
        Map<String, Object> claims = collectClaims(subject, claimNames,
                claimLocales);
     ...
     */
    private Map<String, Object> collectClaims(String subject,
     ...
     * >5.1. Standard Claims</a>" in
     * <a href= "http://openid.net/specs/openid-connect-core-1_0.html">OpenID
     * Connect Core 1.0</a>) are string, but types of {@code email_verified}
     * claim and {@code phone_number_verified} claim are boolean and the type of
     ...
     * claims.put(<span style=
    "color: darkred;">"name"</span>,        <span style=
    "color: darkred;">"Takahiko Kawasaki"</span>);
     * claims.put(<span style=
    "color: darkred;">"given_name"</span>,  <span style=
    "color: darkred;">"Takahiko"</span>);
     * claims.put(<span style=
    "color: darkred;">"family_name"</span>, <span style=
    "color: darkred;">"Kawasaki"</span>);
     *
     ...
     * claims.put(<span style=
    "color: darkred;">"name#ja"</span>,        <span style="color: darkred;"
     * >"\u5DDD\u5D0E \u8CB4\u5F66"</span>);  <span style=
    "color: green;">// &#x5ddd;&#x5D0E; &#x8CB4;&#x5F66;</span>
     * claims.put(<span style=
    "color: darkred;">"given_name#ja"</span>,  <span style="color: darkred;"
     * >"\u8CB4\u5F66"</span>);               <span style=
    "color: green;">// &#x8CB4;&#x5F66;</span>
     * claims.put(<span style=
    "color: darkred;">"family_name#ja"</span>, <span style="color: darkred;"
     * >"\u5DDD\u5D0E"</span>);               <span style=
    "color: green;">// &#x5ddd;&#x5D0E;</span>
     *
     ...
     *     .setFormatted(<span style=
    "color: darkred;">"Itabashi-ku, Tokyo, Japan"</span>);
     * claims.put(<span style="color: darkred;">"address"</span>, address);
     *
     * <span style="color: green;">// Other information.</span>
     * claims.put(<span style="color: darkred;">"gender"</span>,    <span style=
    "color: darkred;">"male"</span>);
     * claims.put(<span style="color: darkred;">"birthdate"</span>, <span style=
    "color: darkred;">"1974-05-06"</span>);
     * claims.put(<span style="color: darkred;">"zoneinfo"</span>,  <span style=
    "color: darkred;">"Asia/Tokyo"</span>);
     * claims.put(<span style="color: darkred;">"locale"</span>,    <span style=
    "color: darkred;">"ja"</span>);
     *
     * <span style=
    "color: green;">// FYI: Constant values in {@link com.authlete.common.types.StandardClaims
     * StandardClaims} class can be used as keys.</span>
     * </pre>
     * 
     * </blockquote>
     *
     ...
     *
     * @param claims
     *            Pairs of claim key and claim value. The pairs are embedded in
     *            an ID token that may be issued. Passing {@code null} means
     ...
     *            authorization code. If {@code null} is given, the scopes
     *            contained in the original authorization request are used.
     *            Otherwise, including the case of an empty array, the scopes
     *            given to this method replace the scopes. Note that
     *            <code>"openid"</code> scope is ignored if it is not included
     *            in the original authorization request.
     *
     * @return A response that should be returned to the client application.
     */
    private Response authorize(String ticket, String subject, long authTime,
            String acr, Map<String, Object> claims, Property[] properties,
            String[] scopes) {
        try {
            ...
            return getApiCaller().authorizationIssue(ticket, subject, authTime,
                    acr, claims, properties, scopes);
        } catch (WebApplicationException e) {
    ...
    /**
     * Generate an error response to indicate that the authorization request
     * failed. This method calls Authlete's {@code
     * /api/auth/authorization/fail} API and generates a response that triggers
     * redirection.
     * </p>
     *
     * @param ticket
    ...
    private Response fail(String ticket, Reason reason) {
        try {
            ...
            return getApiCaller().authorizationFail(ticket, reason)
                    .getResponse();
        } catch (WebApplicationException e) {
            return e.getResponse();
        }
