...
public class AuthorizationPageModel implements Serializable {
    ...
    /**
     * The login ID that should be used as the initial value for the login ID
     * field in the authorization page.
     */
    private String loginId;

    /**
     * This variable holds {@code "readonly"} when the initial value of the
     * login ID should not be changed.
     */
     ...
     * contained in an {@link AuthorizationResponse} object, which represents a
     ...
     *
     * @return The description of the client application.
     */
     ...
     *
     * @return The URL of the logo image of the client application.
     */
     ...
     *
     * @return The URL of the homepage of the client application.
     */
     ...
     *
     * @return The URL of the policy page of the client application.
     */
     ...
     *
     * @return The URL of "Terms of Service" page of the client application.
     */
     ...
     * authorization page as the initial value.
     *
     * @return The initial value of the login ID.
     */
    ...
    /**
     * Set the login ID which should be set to the login ID field in the
     * authorization page as the initial value.
     *
     * @param loginId
    ...
    /**
     * Return {@code "readonly"} if the initial value of the login ID should not
     * be changed.
     *
     * @return {@code "readonly"} if the initial value of the login ID should
     *         not be changed. Otherwise, {@code null}.
     */
     ...
     *            Pass {@code "readonly"} if the initial value of the login ID
     *            should not be changed. Otherwise, pass {@code null}.
     *
     * @return {@code this} object.
     */
     ...
     *            A URI.
     *
     * @return The string representation of the given URI. If {@code null} is
     *         given, {@code null} is returned.
     */
    ...
    /**
     * Compute the initial value for the login ID field in the authorization
     * page.
     */
    ...
    /**
     * Return {@code "readonly"} if the authorization request requires that a
     * specific subject be used.
     */
