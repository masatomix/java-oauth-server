 ...
 *
 * <p>
 * In an implementation of token endpoint, call
 * {@link #handle(MultivaluedMap, String) handle()} method and use the response
...
public class TokenRequestHandler {
     ...
     */
    private final TokenRequestHandlerSpi mSpi = new TokenRequestHandlerSpi() {
        ...
        public Property[] getProperties() {
            ...
            // access token that will be issued as a result of the token
            // request.
            return null;
        }
    };
     ...
     * an implementation of {@link TokenRequestHandlerSpi} interface.
     *
     * @param api
     ...
     *
     * @param authorization
     *            The value of {@code Authorization} header in the token
     *            request. A client application may embed its pair of client ID
     *            and client secret in a token request using
     *            <a href= "https://tools.ietf.org/html/rfc2617#section-2">Basic
     *            Authentication</a>.
     *
    ...
    public Response handle(MultivaluedMap<String, String> parameters,
            String authorization) throws WebApplicationException {
    ...
    private Response process(MultivaluedMap<String, String> parameters,
        ...
        TokenResponse response = getApiCaller().callToken(parameters, clientId,
        ...
        case PASSWORD:
            // Process the token request whose flow is "Resource Owner Password
            // Credentials".
    ...
    private Response handlePassword(TokenResponse response) {
        ...
        if (subject != null) {
            ...
            throw getApiCaller().tokenFail(ticket,
